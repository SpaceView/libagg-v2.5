...
public:
    ...
    virtual void on_draw()
    {
		...
		// --- added bymc ---- test only
		//typedef agg::rgba8 color;
		//typedef agg::span_allocator<color> span_allocator_type;
		//span_allocator_type span_allocator;                  // Span Allocator
		//agg::render_scanlines_aa(ras, sl, renb, span_allocator, spanGradient);
		// ---- end added bymc ----

		agg::render_scanlines_aa_solid(ras, sl, renb, agg::rgba(0, 0, 0));
		//agg::render_scanlines_bin_solid(ras, sl, renb, agg::rgba(0,0,0));
